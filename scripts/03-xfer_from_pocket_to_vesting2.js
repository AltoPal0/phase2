...
async function main() {
  ...
  const vestingWalletAddress = "0xAf4fa52Ec7B6d9288E7aF214a3b6a98e28B923A4";

  // Load the Pocket signer from the private key in .env
  const pocketSigner = new ethers.Wallet(process.env.POCKET_PRIVATE_KEY2, ethers.provider);
