...
async function main() {
  ...
  const vestingWalletAddress = "0xA0e06993446D0FA0c4f81FE455Fb0D19321506bA";

  // Load the Pocket signer from the private key in .env
  const pocketSigner = new ethers.Wallet(process.env.POCKET_PRIVATE_KEY3, ethers.provider);
